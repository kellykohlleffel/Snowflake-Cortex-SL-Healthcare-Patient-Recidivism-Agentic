...
st.set_page_config(
    page_title="CarePathway - Patient Readmission Risk Prevention",
    page_icon="🏥",
    layout="wide",
...
def main():
    ...
    try:
        ...
        <div style="display:flex; align-items:center; margin-bottom:15px">
            ...
            <div>
                <h1 style="font-size:2.2rem; margin:0; padding:0">CarePathway - Patient Readmission Risk Prevention</h1>
                <p style="font-size:1.1rem; color:gray; margin:0; padding:0">Fivetran and Snowflake Cortex-powered data and Agentic AI workflows for Healthcare</p>
            </div>
        </div>
        ''', unsafe_allow_html=True)
        ...
        # Create tabs
        tabs = st.tabs(["Cortex AI Clinical Agents", "Patient Explorer", "Encounter Analysis", "Clinical Events Explorer", "Claims Analysis", "Cortex Patient Insights", "Analysis History", "Settings"])
            ...
            with agent_tabs[0]:
                ...
                with st.container(border=True):
                    ...
                    **Agent Solution**: Autonomous workflow that analyzes recent discharges, assesses readmission risks, 
                    ...
                    # CORTEX MODEL SELECTOR:
                    selected_model_1 = st.selectbox(
                        "Select Snowflake Cortex Model for Analysis:", 
                        MODELS, 
                        key="agent_1_model_selector",
                        help="Choose which Cortex AI model will generate the final analysis"
                    )
        ...
        # Cortex Patient Insights Tab
        with tabs[5]:
            st.header("Cortex Patient Insights")
            ...
            if not patients_df.empty:
                ...
                selected_problem = st.selectbox("Select Patient Insight to Generate", list(analysis_functions.keys()), key="problem_selector")                
                ...
                if st.button("Generate Patient Insight", type="primary", key="cortex_generate_insight"):
                    # Get patient details
...
"""
            ...
            with st.container(border=True):
                ...
                test_model = st.selectbox("Select model to test:", MODELS)
